...
class DashboardScreen extends Component {
  render() {
    return (
      <div className='content-wrapper' style={{ minHeight: 239 }}>
                    ...
                    <div className='tab-content p-0'>
                      ...
                      >
                        ...
                        <canvas
                          ...
                          height={600}
                          style={{ height: 300, display: 'block', width: 651 }}
                          width={1302}
                      ...
                      <div className='chart tab-pane' id='sales-chart' style={{ position: 'relative', height: 300 }}>
                        <canvas
                          ...
                          height={0}
                          style={{ height: 0, display: 'block', width: 0 }}
                          width={0}
                          className='chartjs-render-monitor'
                        />
                      </div>
              ...
              <section className='col-lg-5 connectedSortable ui-sortable'>
                ...
                <div className='card bg-gradient-primary'>
                  ...
                  <div className='card-body'>
                    ...
                    >
                      <svg width='449.156' height={250}>
                        <g transform='scale(0.42158516020236086) translate(53.19901600000004, 0)'>
                          <path
                  ...
                  <div className='card-footer bg-transparent'>
                    <div className='row'>
                      <div className='col-4 text-center'>
                        <div id='sparkline-1'>
                          <canvas width={160} height={100} style={{ width: 80, height: 50 }} />
                        </div>
                ...
                <div className='card bg-gradient-info'>
                  ...
                  <div className='card-body'>
                    ...
                    <canvas
                      ...
                      id='line-chart'
                      style={{ minHeight: 250, height: 250, maxHeight: 250, maxWidth: '100%', display: 'block' }}
                      width={898}
                      height={500}
                    />
                  </div>
                  ...
                  <div className='card-footer bg-transparent'>
                    <div className='row'>
                      <div className='col-4 text-center'>
                        <div style={{ display: 'inline', width: 60, height: 60 }}>
                          <canvas width={120} height={120} style={{ width: 60, height: 60 }} />
                          <input
                            type='text'
                            className='knob'
                            data-readonly='true'
                            ...
                            <div className='datepicker'>
                              <div className='datepicker-days' style={{}}>
                                <table className='table table-sm'>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td data-action='selectDay' data-day='11/29/2020' className='day old weekend'>
                                        29
                                      </td>
                                      <td data-action='selectDay' data-day='11/30/2020' className='day old'>
                                        30
                                      </td>
                                      <td data-action='selectDay' data-day='12/01/2020' className='day active today'>
                                        1
                                      </td>
                                      <td data-action='selectDay' data-day='12/02/2020' className='day'>
                                        2
                                      </td>
                                      <td data-action='selectDay' data-day='12/03/2020' className='day'>
                                        3
                                      </td>
                                      <td data-action='selectDay' data-day='12/04/2020' className='day'>
                                        4
                                      </td>
                                      <td data-action='selectDay' data-day='12/05/2020' className='day weekend'>
                                        5
                                      </td>
                                    </tr>
                                    <tr>
                                      <td data-action='selectDay' data-day='12/06/2020' className='day weekend'>
                                        6
                                      </td>
                                      <td data-action='selectDay' data-day='12/07/2020' className='day'>
                                        7
                                      </td>
                                      <td data-action='selectDay' data-day='12/08/2020' className='day'>
                                        8
                                      </td>
                                      <td data-action='selectDay' data-day='12/09/2020' className='day'>
                                        9
                                      </td>
                                      <td data-action='selectDay' data-day='12/10/2020' className='day'>
                                        10
                                      </td>
                                      <td data-action='selectDay' data-day='12/11/2020' className='day'>
                                        11
                                      </td>
                                      <td data-action='selectDay' data-day='12/12/2020' className='day weekend'>
                                        12
                                      </td>
                                    </tr>
                                    <tr>
                                      <td data-action='selectDay' data-day='12/13/2020' className='day weekend'>
                                        13
                                      </td>
                                      <td data-action='selectDay' data-day='12/14/2020' className='day'>
                                        14
                                      </td>
                                      <td data-action='selectDay' data-day='12/15/2020' className='day'>
                                        15
                                      </td>
                                      <td data-action='selectDay' data-day='12/16/2020' className='day'>
                                        16
                                      </td>
                                      <td data-action='selectDay' data-day='12/17/2020' className='day'>
                                        17
                                      </td>
                                      <td data-action='selectDay' data-day='12/18/2020' className='day'>
                                        18
                                      </td>
                                      <td data-action='selectDay' data-day='12/19/2020' className='day weekend'>
                                        19
                                      </td>
                                    </tr>
                                    <tr>
                                      <td data-action='selectDay' data-day='12/20/2020' className='day weekend'>
                                        20
                                      </td>
                                      <td data-action='selectDay' data-day='12/21/2020' className='day'>
                                        21
                                      </td>
                                      <td data-action='selectDay' data-day='12/22/2020' className='day'>
                                        22
                                      </td>
                                      <td data-action='selectDay' data-day='12/23/2020' className='day'>
                                        23
                                      </td>
                                      <td data-action='selectDay' data-day='12/24/2020' className='day'>
                                        24
                                      </td>
                                      <td data-action='selectDay' data-day='12/25/2020' className='day'>
                                        25
                                      </td>
                                      <td data-action='selectDay' data-day='12/26/2020' className='day weekend'>
                                        26
                                      </td>
                                    </tr>
                                    <tr>
                                      <td data-action='selectDay' data-day='12/27/2020' className='day weekend'>
                                        27
                                      </td>
                                      <td data-action='selectDay' data-day='12/28/2020' className='day'>
                                        28
                                      </td>
                                      <td data-action='selectDay' data-day='12/29/2020' className='day'>
                                        29
                                      </td>
                                      <td data-action='selectDay' data-day='12/30/2020' className='day'>
                                        30
                                      </td>
                                      <td data-action='selectDay' data-day='12/31/2020' className='day'>
                                        31
                                      </td>
                                      <td data-action='selectDay' data-day='01/01/2021' className='day new'>
                                        1
                                      </td>
                                      <td data-action='selectDay' data-day='01/02/2021' className='day new weekend'>
                                        2
                                      </td>
                                    </tr>
                                    <tr>
                                      <td data-action='selectDay' data-day='01/03/2021' className='day new weekend'>
                                        3
                                      </td>
                                      <td data-action='selectDay' data-day='01/04/2021' className='day new'>
                                        4
                                      </td>
                                      <td data-action='selectDay' data-day='01/05/2021' className='day new'>
                                        5
                                      </td>
                                      <td data-action='selectDay' data-day='01/06/2021' className='day new'>
                                        6
                                      </td>
                                      <td data-action='selectDay' data-day='01/07/2021' className='day new'>
                                        7
                                      </td>
                                      <td data-action='selectDay' data-day='01/08/2021' className='day new'>
                                        8
                                      </td>
                                      <td data-action='selectDay' data-day='01/09/2021' className='day new weekend'>
                                        9
                                      </td>
                                    </tr>
                                  </tbody>
                              ...
                              <div className='datepicker-months' style={{ display: 'none' }}>
                                <table className='table-condensed'>
                                  <thead>
                                    <tr>
                                      <th className='prev' data-action='previous'>
                                        <span className='fa fa-chevron-left' title='Previous Year' />
                                      </th>
                                      <th
                                        className='picker-switch'
                                        data-action='pickerSwitch'
                                      ...
                                      <th className='next' data-action='next'>
                                        <span className='fa fa-chevron-right' title='Next Year' />
                                      </th>
                                    </tr>
                                  </thead>
                                  <tbody>
                                    <tr>
                                      <td colSpan={7}>
                                        ...
                                        <span data-action='selectMonth' className='month active'>
                                          Dec
                                        </span>
                                      </td>
                                    </tr>
                              ...
                              <div className='datepicker-years' style={{ display: 'none' }}>
                                <table className='table-condensed'>
                                  <thead>
                                    <tr>
                                      <th className='prev' data-action='previous'>
                                        <span className='fa fa-chevron-left' title='Previous Decade' />
                                      </th>
                                      <th
                                        className='picker-switch'
                                        data-action='pickerSwitch'
                                      ...
                                      <th className='next' data-action='next'>
                                        <span className='fa fa-chevron-right' title='Next Decade' />
                                      </th>
                                    </tr>
                                  </thead>
                                  <tbody>
                              ...
                              <div className='datepicker-decades' style={{ display: 'none' }}>
                                <table className='table-condensed'>
                                  <thead>
                                    <tr>
                                      <th className='prev' data-action='previous'>
                                        <span className='fa fa-chevron-left' title='Previous Century' />
                                      </th>
                                      <th className='picker-switch' data-action='pickerSwitch' colSpan={5}>
                                        2000-2090
                                      </th>
                                      <th className='next' data-action='next'>
                                        <span className='fa fa-chevron-right' title='Next Century' />
                                      </th>
                                    </tr>
                                  </thead>
                                  <tbody>
                                    <tr>
                                      <td colSpan={7}>
                                        <span data-action='selectDecade' className='decade old' data-selection={2006}>
                                          1990
                                        </span>
                                        <span data-action='selectDecade' className='decade' data-selection={2006}>
                                          2000
                                        </span>
                                        <span
                                        ...
                                        <span data-action='selectDecade' className='decade' data-selection={2026}>
                                          2020
                                        </span>
                                        <span data-action='selectDecade' className='decade' data-selection={2036}>
                                          2030
                                        </span>
                                        <span data-action='selectDecade' className='decade' data-selection={2046}>
                                          2040
                                        </span>
                                        <span data-action='selectDecade' className='decade' data-selection={2056}>
                                          2050
                                        </span>
                                        <span data-action='selectDecade' className='decade' data-selection={2066}>
                                          2060
                                        </span>
                                        <span data-action='selectDecade' className='decade' data-selection={2076}>
                                          2070
                                        </span>
                                        <span data-action='selectDecade' className='decade' data-selection={2086}>
                                          2080
                                        </span>
                                        <span data-action='selectDecade' className='decade' data-selection={2096}>
                                          2090
                                        </span>
                                        <span data-action='selectDecade' className='decade old' data-selection={2106}>
                                          2100
                                        </span>
                                      </td>
                                    </tr>
